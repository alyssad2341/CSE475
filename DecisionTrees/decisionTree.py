...
# Features
X =  pima_df[['Pregnancies', 'Glucose', 'BloodPressure', 'SkinThickness', 'Insulin', 'BMI', 'DiabetesPedigreeFunction', 'Age']].values # YOUR CODE HERE

# Target variable
y = pima_df['Outcome'].values # YOUR CODE HERE
...
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.05, random_state=0)  # YOUR CODE HERE
...
clf = DecisionTreeClassifier(criterion="entropy", random_state=30, max_depth=5, min_samples_leaf=3) # YOUR CODE HERE
